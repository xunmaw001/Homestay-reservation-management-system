...
public class DictionaryServletContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        if (myThreadMethod == null) {
            ...
            MinsuService minsuService = (MinsuService)appContext.getBean("minsuService");
            myThreadMethod.setMinsuService(minsuService);

            MinsuzulinService minsuzulinService = (MinsuzulinService)appContext.getBean("minsuzulinService");
            myThreadMethod.setMinsuzulinService(minsuzulinService);
