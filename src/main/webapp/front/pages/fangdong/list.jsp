                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="fangdongName" id="fangdongName" placeholder="房东姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#fangdongName').val() != null && jquery('#fangdongName').val() != "" && jquery('#fangdongName').val() != "null" ) {
                param['fangdongName'] = jquery('#fangdongName').val();
            }
