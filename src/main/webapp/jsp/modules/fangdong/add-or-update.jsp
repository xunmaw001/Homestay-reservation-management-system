                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 fangdongNameDiv">
                                        <label>房东姓名</label>
                                    ...
                                    <div class="form-group col-md-6 fangdongIdNumberDiv">
                                        <label>身份证号</label>
                                    ...
                                    <div class="form-group col-md-6 fangdongPhoneDiv">
                                        <label>手机号</label>
                                    ...
                                    <div class="form-group col-md-6 fangdongPhotoDiv">
                                        <label>照片</label>
