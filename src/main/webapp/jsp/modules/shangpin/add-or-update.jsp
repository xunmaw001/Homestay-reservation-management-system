                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 shangpinClicknumDiv" style="display:none;">
                                        <label>点击次数</label>
                                        <input style="width: 450px" value="0" id="shangpinClicknum" name="shangpinClicknum" class="form-control"
