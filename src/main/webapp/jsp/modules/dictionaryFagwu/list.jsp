            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">房屋类型管理</li>
                        <li class="breadcrumb-item active">房屋类型列表</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="layui-inline" style="margin-bottom: 10px;">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" id="indexNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                               placeholder="房屋类型名称" aria-controls="tableId">
                                    </div>
                                </div>
