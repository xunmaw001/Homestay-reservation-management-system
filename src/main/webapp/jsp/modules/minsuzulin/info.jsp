            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">民宿租赁登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="minsuName" name="minsuName" class="form-control"
                                                   v-model="ruleForm.minsuName" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="fagwuValue" name="fagwuValue" class="form-control"
                                               v-model="ruleForm.fagwuValue" readonly>
                                    </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="minsuNewMoney" name="minsuNewMoney" class="form-control"
                                                   v-model="ruleForm.minsuNewMoney" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>房屋图片</label>
                                        <img id="minsuPhotoImg" width="100" height="100">
                                    </div>

                                        <div class="form-group col-md-6">
                                            <label>地址</label>
                                            <input style="width: 450px" id="minsuAddress" name="minsuAddress" class="form-control"
                                                   v-model="ruleForm.minsuAddress" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="fwstateValue" name="fwstateValue" class="form-control"
                                               v-model="ruleForm.fwstateValue" readonly>
                                    </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>所属房东</label>
                                            <input style="width: 450px" id="fangdongId" name="fangdongId" class="form-control"
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="minsuId" name="minsuId" v-model="ruleForm.minsuId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>退房时间</label>
                                        <input style="width: 450px" id="tuifangTime" name="tuifangTime" class="form-control"
                                               v-model="ruleForm.tuifangTime" readonly>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "minsuzulin/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.minsuContent != null && ruleForm.minsuContent != 'null' && ruleForm.minsuContent != '') {
            var minsuContentUeditor = UE.getEditor('minsuContentEditor');
                minsuContentUeditor.ready(function () {
                    ...
                    minsuContentUeditor.setDisabled('fullscreen');
            });
        }
    }
